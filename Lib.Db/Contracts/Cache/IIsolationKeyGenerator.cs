...
public interface IIsolationKeyGenerator
{
    ...
    /// 데이터베이스 연결 문자열
    /// <br/>예: "Server=localhost;Database=ExampleDb;Integrated Security=True;TrustServerCertificate=True;Encrypt=False;"
    /// </param>
    /// <returns>
    ...
    /// var key = generator.Generate("Server=localhost;Database=ExampleDb;Integrated Security=True;TrustServerCertificate=True;Encrypt=False;");
