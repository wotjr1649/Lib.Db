param(
    ...
    [string] $ResultsDirectory = 'TestResults\CoverletV230',
    [string] $ReportDirectory = 'TestResults\CoverageReport-v230',
    [switch] $SkipReport,
    [switch] $SkipGate,
    [switch] $RestoreTools
)
...
$assertScript = Join-Path $repoRoot 'Tools\coverage\Assert-LibDbCoverage.ps1'
