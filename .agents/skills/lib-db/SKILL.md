...
- Stored procedure output parameters copy back after successful command completion; streaming and multiple-result APIs require full consumption or clean disposal before reading output values.
