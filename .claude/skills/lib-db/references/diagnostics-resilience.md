...
`LibDbOptions.ResilienceOptions` is exposed through `options.Resilience`; application code normally configures that nested options object rather than constructing it directly.
