...
public sealed class TvpSchemaValidatorTests
{
        ...
        TvpSchema schema = new()
        {
            ...
            [
                new TvpColumnMetadata(
                    ...
                    NameHash: unchecked((int)SharedHashUtils.HashAsciiIgnoreCaseFnv1a(nameof(StaticValidatorRow.Id))),
                    MaxLength: 4,
                    Ordinal: 0,
    ...
    public async Task ValidateAsync_ShouldRejectRuntimeNameMismatchWhenNameHashCollides()
    {
        ...
        TvpSchema schema = new()
        {
            ...
            [
                new TvpColumnMetadata(
                    Name: "DifferentId",
                    NameHash: unchecked((int)SharedHashUtils.HashAsciiIgnoreCaseFnv1a(nameof(RuntimeIdentityRow.Id))),
                    MaxLength: 4,
                    Ordinal: 0,
                    SqlDbType: SqlDbType.Int,
                    Precision: 0,
    ...
    private static TvpColumnMetadata Column(
        ...
        => new(
            Name: name,
            NameHash: unchecked((int)SharedHashUtils.HashAsciiIgnoreCaseFnv1a(name)),
            MaxLength: 0,
            Ordinal: ordinal,
            SqlDbType: sqlDbType,
            Precision: 0,
